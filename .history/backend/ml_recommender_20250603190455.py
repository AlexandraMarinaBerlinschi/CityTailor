...
class MLRecommender:
    ...
    def __init__(self):
        ...
        self.random_activities_data = {
            "paris": [
                ...
                {
                    "name": "Versailles Royal Gardens Stroll",
                    "category": "Outdoor",
                    "minimumDuration": ">4h",
                    "description": "Explore the magnificent gardens of Versailles Palace. Perfect for a leisurely day among fountains and manicured landscapes.",
                    "pictures": ["https://source.unsplash.com/600x400/?versailles,gardens,palace"]
                },
                {
                    "name": "Parisian Rooftop Wine Tasting",
                    "category": "Gastronomy",
                    "minimumDuration": "<2h",
                    "description": "Sample exceptional French wines while enjoying panoramic views of the City of Light from exclusive rooftop terraces.",
                    "pictures": ["https://source.unsplash.com/600x400/?paris,rooftop,wine"]
                }
            ],
            "rome": [
                {
                ...
                {
                    "name": "Roman Forum Underground Adventure",
                    "category": "Cultural",
                    "minimumDuration": "2-4h",
                    "description": "Discover the hidden underground levels of ancient Rome. Explore chambers and passages rarely seen by tourists.",
                    "pictures": ["https://source.unsplash.com/600x400/?roman-forum,underground,ancient"]
                },
                {
                    "name": "Aperitivo and Sunset at Orange Garden",
                    "category": "Relaxation",
                    "minimumDuration": "<2h",
                    "description": "Watch the sunset over Rome from the peaceful Orange Garden on Aventine Hill while enjoying Italian aperitivo.",
                    "pictures": ["https://source.unsplash.com/600x400/?rome,sunset,garden"]
                }
            ],
            "tokyo": [
                {
                ...
                {
                    "name": "Harajuku Street Fashion Discovery",
                    "category": "Cultural",
                    "minimumDuration": "2-4h",
                    "description": "Explore Tokyo's most vibrant fashion district. Discover unique styles and pop culture in the heart of youth fashion.",
                    "pictures": ["https://source.unsplash.com/600x400/?harajuku,tokyo,fashion"]
                },
                {
                    "name": "Mount Fuji View from Hakone",
                    "category": "Outdoor",
                    "minimumDuration": ">4h",
                    "description": "Day trip to Hakone for stunning Mount Fuji views, hot springs, and traditional ryokan experience.",
                    "pictures": ["https://source.unsplash.com/600x400/?mount-fuji,hakone,views"]
                }
            ],
            "barcelona": [
                {
                ...
                {
                    "name": "Montjuïc Castle and Gardens",
                    "category": "Outdoor",
                    "minimumDuration": "2-4h",
                    "description": "Explore the historic castle and beautiful botanical gardens with panoramic views over Barcelona and the sea.",
                    "pictures": ["https://source.unsplash.com/600x400/?montjuic,castle,barcelona"]
                },
                {
                    "name": "Flamenco Night in Gràcia",
                    "category": "Cultural",
                    "minimumDuration": "<2h",
                    "description": "Experience authentic flamenco in an intimate venue in the bohemian Gràcia neighborhood.",
                    "pictures": ["https://source.unsplash.com/600x400/?flamenco,barcelona,gracia"]
                }
            ],
            "london": [
                {
                ...
                {
                    "name": "Camden Market Alternative Culture",
                    "category": "Cultural",
                    "minimumDuration": "2-4h",
                    "description": "Explore London's alternative culture hub. Discover vintage fashion, street art, and eclectic food stalls.",
                    "pictures": ["https://source.unsplash.com/600x400/?camden-market,london,alternative"]
                },
                {
                    "name": "Hampstead Heath Nature Escape",
                    "category": "Outdoor",
                    "minimumDuration": ">4h",
                    "description": "Escape the city hustle in this beautiful heath. Enjoy swimming ponds, countryside walks, and city skyline views.",
                    "pictures": ["https://source.unsplash.com/600x400/?hampstead-heath,london,nature"]
                }
            ],
            "new york": [
                {
                    "name": "Brooklyn Bridge Sunrise Walk",
                    "category": "Outdoor",
                    "minimumDuration": "<2h",
                    "description": "Walk across the iconic bridge at sunrise for stunning Manhattan skyline views without the crowds.",
                    "pictures": ["https://source.unsplash.com/600x400/?brooklyn-bridge,sunrise,manhattan"]
                },
                {
                    "name": "Central Park Hidden Gems",
                    "category": "Relaxation",
                    "minimumDuration": "2-4h",
                    "description": "Discover secret spots in Central Park: the Shakespeare Garden, Belvedere Castle, and quiet meadows.",
                    "pictures": ["https://source.unsplash.com/600x400/?central-park,hidden,peaceful"]
                },
                {
                    "name": "Greenwich Village Jazz Night",
                    "category": "Cultural",
                    "minimumDuration": "<2h",
                    "description": "Experience authentic jazz in intimate Greenwich Village clubs where legends once performed.",
                    "pictures": ["https://source.unsplash.com/600x400/?greenwich-village,jazz,nightlife"]
                },
                {
                    "name": "Food Truck Festival Tour",
                    "category": "Gastronomy",
                    "minimumDuration": "2-4h",
                    "description": "Sample diverse street food from NYC's best food trucks. A culinary journey around the world in one city.",
                    "pictures": ["https://source.unsplash.com/600x400/?food-trucks,nyc,street-food"]
                },
                {
                    "name": "High Line Elevated Park",
                    "category": "Outdoor",
                    "minimumDuration": "2-4h",
                    "description": "Stroll through this unique elevated park built on former railway tracks with art installations and city views.",
                    "pictures": ["https://source.unsplash.com/600x400/?high-line,elevated-park,nyc"]
                },
                {
                    "name": "Broadway Behind the Scenes",
                    "category": "Cultural",
                    "minimumDuration": ">4h",
                    "description": "Go behind the scenes of Broadway shows. Meet performers, see costumes, and learn about theater magic.",
                    "pictures": ["https://source.unsplash.com/600x400/?broadway,theater,behind-scenes"]
                }
            ]
        }
    ...
    async def _get_general_recommendations(self, db: AsyncSession, limit: int) -> Dict:
        ...
        # Obține locurile cele mai populare din DB (doar 2)
        result = await db.execute(
            select(PlacePopularity)
            .order_by(desc(PlacePopularity.popularity_score))
            .limit(2)
        ...
        # Adaugă mai multe activități random
        random_activities = self._generate_random_activities(6)
        
        # Combină recomandările
        all_recommendations = db_recommendations + random_activities
        random.shuffle(all_recommendations)  # Amestecă pentru diversificare
        
        return {
            'main_recommendations': all_recommendations[:4],
            'discover_new_places': random_activities[:3],
            'trending_worldwide': db_recommendations[:2],
    ...
    async def _get_new_user_recommendations(self, db: AsyncSession, limit: int) -> Dict:
        ...
        # Generează mai multe activități random pentru utilizatori noi
        random_activities = self._generate_random_activities(6)
        ...
        return {
            'main_recommendations': all_recommendations[:4],
            'discover_new_places': random_activities[:3],
            'trending_for_beginners': db_recommendations[:2],
            'personalization_level': 'discovery',
    ...
    def _generate_random_activities(self, limit: int) -> List[Dict]:
        ...
        # Selectează toate orașele pentru mai multă diversitate
        for city in cities:
            city_activities = self.random_activities_data[city]
            # Selectează 1-2 activități din fiecare oraș
            num_to_select = min(2, len(city_activities))
            selected = random.sample(city_activities, num_to_select)
    ...
    async def _get_personalized_recommendations(
        ...
        # Obține mai puține recomandări din DB și mai multe random
        city_recommendations = await self._get_recommendations_for_favorite_cities(
            db, behavior['favorite_cities'], 2  # Doar 2 din DB
        )
        
        # Obține recomandări bazate pe preferințe
        category_recommendations = await self._get_recommendations_by_preferences(
            db, behavior['preferences'], 2  # Doar 2 din DB
        )
        
        # Adaugă mai multe surprize random
        surprise_activities = self._generate_targeted_random_activities(
            behavior['preferences'], 4  # Mărește de la 2 la 4
        )
        
        # Adaugă activități complet random pentru diversificare
        random_activities = self._generate_random_activities(2)
        
        # Combină rezultatele
        all_recommendations = city_recommendations + category_recommendations + surprise_activities + random_activities
        ...
        # Amestecă pentru diversificare
        random.shuffle(unique_recommendations)
        
        return {
            'main_recommendations': unique_recommendations[:4],
            'in_your_favorite_cities': city_recommendations[:2],
            'matching_your_interests': category_recommendations[:2],
            'surprise_discoveries': surprise_activities[:4],
    ...
    def _convert_places_to_recommendations(
        ...
        for place in places:
            recommendations.append({
                ...
                'pictures': [f"https://source.unsplash.com/400x300/?{place.place_name.replace(' ', '%20')},{place.city}"],  # Fix pentru poze
