...
const Recommendations = () => {
  ...
  const categories = [
    ...
    { id: 'culture', name: 'Cultură', icon: '🏛️' },
    { id: 'adventure', name: 'Aventură', icon: '🏔️' },
    { id: 'food', name: 'Gastronomie', icon: '🍽️' },
    { id: 'nature', name: 'Natură', icon: '🌿' },
  ];
  ...
  const stats = {
    ...
    averagePrice: Math.round(Math.random() * 50 + 70) // Mock average price
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 mb-3">
                            ...
                            <div className="text-green-600 font-bold">
                              {Math.round(Math.random() * 100 + 50)} RON / persoană
                            </div>
                          </div>
          ...
          <div className="space-y-6">
            ...
            {/* Quick Actions */}
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-4">⚡ Acțiuni rapide</h4>
              <div className="space-y-3">
                <button className="w-full flex items-center space-x-3 p-3 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl hover:shadow-md transition-all">
                  <span className="text-2xl">📋</span>
                  <div className="text-left">
                    <p className="font-medium text-green-800">Exportă lista</p>
                    <p className="text-sm text-green-600">PDF, CSV sau JSON</p>
                  </div>
                </button>
                
                <button className="w-full flex items-center space-x-3 p-3 bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-xl hover:shadow-md transition-all">
                  <span className="text-2xl">🔗</span>
                  <div className="text-left">
                    <p className="font-medium text-purple-800">Partajează</p>
                    <p className="text-sm text-purple-600">Trimite prietening</p>
                  </div>
                </button>
                
                <button className="w-full flex items-center space-x-3 p-3 bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-xl hover:shadow-md transition-all">
                  <span className="text-2xl">❤️</span>
                  <div className="text-left">
                    <p className="font-medium text-orange-800">Favorite ({favorites.size})</p>
                    <p className="text-sm text-orange-600">Locurile tale preferate</p>
                  </div>
                </button>
              </div>
            </div>
