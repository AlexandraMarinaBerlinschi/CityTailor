    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50">
      ...
      <div className="relative overflow-hidden text-white py-16">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://st2.depositphotos.com/3837271/5507/i/450/depositphotos_55072853-stock-photo-time-to-travel-wooden-sign.jpg')`
          }}
        ></div>
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl lg:text-2xl opacity-90 max-w-2xl mx-auto leading-relaxed">
            Tell us your travel dreams and let's create an itinerary just for you
          </p>
