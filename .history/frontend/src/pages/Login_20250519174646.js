...
const Login = ({ setIsAuthenticated }) => {
  ...
  const handleLogin = async () => {
    ...
    if (error) {
      ...
      // Check if there's a pending itinerary to restore
      const pendingItinerary = sessionStorage.getItem('pendingItinerary');
      
      if (pendingItinerary) {
        // Clear the pending itinerary from sessionStorage
        sessionStorage.removeItem('pendingItinerary');
        
        // Navigate to the itinerary page with the restored data
        ...
        // Regular login flow - navigate to home
        navigate('/home');
      }
    } else {
