      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 py-12 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center space-y-4">
            <button
              onClick={handleReset}
              className="inline-flex items-center px-8 py-3 text-lg font-semibold text-gray-700 bg-white border-2 border-gray-300 rounded-full shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-105 mr-4"
            >
            ...
            <div className="text-sm text-gray-500 mt-4">
              <p>💡 Tip: In a real application, this would redirect you to your personalized recommendations!</p>
            </div>
          </div>
        </div>
