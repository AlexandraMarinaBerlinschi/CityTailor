            ...
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                  ...
                  <p className="text-sm opacity-80">Handpicked locations from around the world</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                  <div className="text-3xl mb-3">📱</div>
                  <h3 className="font-semibold mb-2">Smart Planning</h3>
                  <p className="text-sm opacity-80">Create and manage your travel itinerary</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                  <div className="text-3xl mb-3">⭐</div>
                  <h3 className="font-semibold mb-2">Personalized</h3>
                  <p className="text-sm opacity-80">Recommendations that match your style</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              {[
                {
                  name: "Paris, France",
                  image: "https://images.unsplash.com/photo-1502602898536-47ad22581b52?w=400&h=300&fit=crop&q=80",
