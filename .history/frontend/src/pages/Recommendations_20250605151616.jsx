              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 rounded-2xl p-6 sticky top-24">
                ...
                <div className="space-y-3 mb-4">
                  <p className="text-sm text-purple-700">
                    We analyzed your preferences and found {aiCount} personalized recommendations just for you.
                  </p>
                  ...
                  {aiCount > 3 && (
                    <p className="text-sm text-purple-700 text-center">
                      +{aiCount - 3} more of our recommendations
                    </p>
                  )}
                </div>
              ...
              <div className="space-y-3 text-sm text-orange-800">
                {aiCount > 0 ? (
                  <>
                    ...
                    <p>• ❤️ Save favorites to get more of recommendations</p>
                ...
                {!isUserAuthenticated() && (
                  <p className="text-orange-600 font-medium">• 🔐 Login to unlock personalized recommendations</p>
                )}
              </div>
            </div>
          </div>
