      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50">
        ...
        <div className="relative overflow-hidden min-h-screen">
          ...
          <div 
            ...
            style={{
              backgroundImage: `url('https://res.cloudinary.com/gwatco/image/upload/dpr_auto/t_image-card/f_auto/v1748736000/new-website/static/homepage/global-travel-cover/banner.webp')`
            }}
          ></div>
