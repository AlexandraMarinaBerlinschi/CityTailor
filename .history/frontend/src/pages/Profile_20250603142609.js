      ...
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl p-8 space-y-6">
        ...
        <div className="space-y-5">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full mt-3 flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 rounded-lg font-medium hover:from-purple-700 hover:to-pink-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
            <span className="text-lg">🧠</span> View AI Travel Insights
          </button>
