...
const Itinerary = () => {
  ...
  const [authCheckComplete, setAuthCheckComplete] = useState(false); // New state
  ...
  useEffect(() => {
    if (authCheckComplete && userId) {
      // Re-check authentication when userId is set
      checkAuthentication();
    }
  ...
  const saveItinerary = async () => {
    ...
    // Double-check authentication before showing dialog
