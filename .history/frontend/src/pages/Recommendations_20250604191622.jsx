              ...
              <div className="p-6 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-semibold text-gray-900">
                    {filterByAI === 'ai' ? '🤖 AI Recommendations' : 
              ...
              {filteredRecommendations.length === 0 && (
                <div className="p-12 text-center">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-2">
                    No {filterByAI === 'ai' ? 'AI recommendations' : filterByAI === 'regular' ? 'search results' : 'recommendations'} found
                  </h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 border border-yellow-200 rounded-2xl p-6">
              <h4 className="text-lg font-semibold text-orange-900 mb-3 flex items-center">
                <span className="mr-2">💡</span>
                {aiCount > 0 ? 'AI Tips' : 'Useful tips'}
              </h4>
              <div className="space-y-3 text-sm text-orange-800">
                {aiCount > 0 ? (
                  <>
                    <p>• 🤖 AI recommendations are marked with colored badges</p>
                    <p>• 🎯 Purple badges = perfect match for your search</p>
                    <p>• 👤 Blue badges = based on your preferences</p>
                    <p>• 👥 Green badges = popular with similar users</p>
                    <p>• 🔍 Orange badges = new discoveries for you</p>
                    <p>• ❤️ Favorites help AI learn your taste better</p>
                  </>
                ) : (
                  <>
