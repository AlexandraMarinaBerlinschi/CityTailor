...
const loadItineraryData = async (authenticatedUserId = null) => {
  ...
  const totalDuration = itinerary.reduce((sum, item) => {
    if (item.duration) {
      // Extract only the first number from duration string
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-200">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-start space-x-2">
                  <span className="text-blue-600 mt-0.5">•</span>
                  <span className="text-gray-700">Create a meaningful title for your itinerary to find it easily later</span>
                </div>
                ...
                <div className="space-y-3 text-sm text-gray-700">
                  <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                    <div className="flex items-center space-x-2 mb-1">
                      ...
                      <span className="font-medium text-yellow-800">Timing</span>
                    </div>
                    <p className="text-yellow-700">Consider travel time between locations when planning your day</p>
                  </div>
                  ...
                  <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <p className="text-green-700">Total estimated cost: {totalCost} EUR (entrance fees may vary)</p>
                  </div>
                  ...
                  <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <p className="text-blue-700">Organize places by proximity to minimize travel time</p>
                  </div>
                </div>
              </div>
            )}
