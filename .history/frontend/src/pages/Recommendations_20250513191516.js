...
const Recommendations = () => {
  ...
  const savedItinerary = location.state?.itinerary || []; // Primește itinerariul salvat din state
  ...
  // Navigare către pagina de itinerariu
      ...
      {itinerary.length > 0 && (
        <div className="mb-6 p-4 bg-blue-50 rounded-lg shadow">
          <div className="flex justify-between items-center mb-2">
            <h3 className="text-lg font-medium text-blue-800">Itinerariul tău ({itinerary.length} locații)</h3>
            <button 
